        ...
        <div class="row">
            ...
            <div class="col-md-6 mb-4 mb-md-0">
                ...
                <ul class="list-unstyled mb-4">
                    ...
                    <li class="mb-3">
                        <strong class="font-weight-bold">Email:</strong> <a href="mailto:smabovent@yahoo.co.id" class="text-primary">smabovent@yahoo.co.id</a>
                    </li>
                    <li class="mb-3">
                        <strong class="font-weight-bold">Telepon:</strong> <a href="tel:(0351) 454194" class="text-primary">(0351) 454194</a>
                    </li>
                </ul>
